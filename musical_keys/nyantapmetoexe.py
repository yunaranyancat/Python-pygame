...
#font config
titleFontblack = pygame.font.Font('black.ttf',70)

smallFontgiveme = pygame.font.Font('GiveMeAHand.ttf',30)
mediumFontgiveme = pygame.font.Font('GiveMeAHand.ttf',60)
largeFontgiveme = pygame.font.Font('GiveMeAHand.ttf',90)
...
#PURRRR
nyansound = pygame.mixer.Sound("nyan.wav")
evilsound = pygame.mixer.Sound("maniac.wav")
...
def gameLoop():
    ...
    while not gameExit:
        ...
        if gameOver == True:
            ...
            screen_message("Q to restart, R to quit",white,0,0,"medium")
