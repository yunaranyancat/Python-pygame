...
import time
import random
#Create game icon and fixing apple random position
...
icon = pygame.image.load('./extras/icon.png') #32px32px
...
def game_intro():
    ...
    while intro:
        ...
        clock.tick(15) #pygame.org/docs/ref/time.html#pygame.time.Clock.tick
